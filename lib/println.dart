...
class PrintlnConfig {
  ...
  static bool releaseOn = false;
  static String separator = " ";
  static String keyValueSeparator = ":";
  static String entrySeparator = ", ";
  static String listMapSeparator = ", ";
}

dynamic println = PrintlnCall();
...
class PrintlnCall {
  ...
  String _doPrint(List<dynamic> ls, Map<String, dynamic> map) {
    ...
    if (_isReleaseMode && !PrintlnConfig.releaseOn) return "";
    if (_isDebugMode && !PrintlnConfig.debugOn) return "";
  ...
  String _buildLine(List<dynamic> ls, Map<String, dynamic> map, {required String sep}) {
    ...
    String b = map.entries.where((e) => !e.key.startsWith("\$")).map((e) => "${e.key}${PrintlnConfig.keyValueSeparator}${e.value}").join(PrintlnConfig.entrySeparator);
